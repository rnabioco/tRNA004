...
* [Condensed protocol]([url](https://docs.google.com/document/d/1SF2dGrVZLOtweABMiu8x1vZq7Yw5z260S80RhcLeO_o/edit?usp=sharing)) (Google doc)
* [Long form protocol]([url](https://benchling.com/s/prt-hGDLQuwsw0qKaWrtc70u?m=slm-kowx2TQzGlx2LAxpZwXk)) with dynamic tables for calculating reactions with varying inputs (Benchling, thanks to Kezia Dobson)
