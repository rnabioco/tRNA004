...
process_files("ecoli")
process_files("T4infectedecoli")
process_files("dmelanogaster")
bind_rows(scerevisiae_mappings, hsapiens_mappings, tthermophila_mappings, ecoli_mappings, T4infectedecoli_mappings, dmelanogaster_mappings) -> mappings
rm(scerevisiae_mappings, hsapiens_mappings, tthermophila_mappings, ecoli_mappings, T4infectedecoli_mappings, dmelanogaster_mappings)
```
