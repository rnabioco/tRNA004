...
```
So now, what can we say about these 27 different modifications?
```{r}
# Creating a violin plot
ggplot(mapped, aes(x = mod_nt, y = BCerror)) +
  geom_violin(trim = FALSE) +
  theme_bw() +
  labs(title = "Basecalling error for modified nucleotides in budding yeast tRNAs",
       x = "mod_nt",
       y = "BCerror")
```
