...
parse_fasta(here("Modomics/modified_all_trna_sequences.fasta")) -> all_modified
```
...
# Filter out for characters that are not A, C, G, or U
distribution_summary <- distribution_summary %>%
                        filter(NonStandardChars != "")

# Join the tables to filter the species
filtered_distribution_summary <- inner_join(distribution_summary, species_counts_filtered, by = "Species")
```


```{r}
# List of desired species
desired_species <- c("Escherichia coli", "Homo sapiens", "Saccharomyces cerevisiae", "Drosophila melanogaster", "Tetrahymena thermophila", "Enterobacteria phage T4")  # Replace with your species
