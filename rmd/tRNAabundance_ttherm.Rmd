...
library(forcats)
library(here)
here::i_am("Rmd/tRNAabundance_ttherm.Rmd")
```
...
read_tRNA(here("rebasecalling/bedgraphs/Tetrahymena002_20231207_1743_MN35252_FAX30455_c9f80979.rna002_70bps_fast@v3.bg"), "T_thermophila", "RNA002", "fast") -> fast2
read_tRNA(here("rebasecalling/bedgraphs/Tetrahymena002_20231207_1743_MN35252_FAX30455_c9f80979.rna002_70bps_hac@v3.bg"), "T_thermophila", "RNA002", "hac") -> hac2
read_tRNA(here("rebasecalling/bedgraphs/Tetrahymena004_20231208_0920_MN42516_FAX71838_a244513d.rna004_130bps_fast@v3.0.1.bg"), "T_thermophila", "RNA004", "fast") -> fast4
read_tRNA(here("rebasecalling/bedgraphs/Tetrahymena004_20231208_0920_MN42516_FAX71838_a244513d.rna004_130bps_hac@v3.0.1.bg"), "T_thermophila", "RNA004", "hac") -> hac4
read_tRNA(here("rebasecalling/bedgraphs/Tetrahymena004_20231208_0920_MN42516_FAX71838_a244513d.rna004_130bps_sup@v3.0.1.bg"), "T_thermophila", "RNA004", "sup") -> sup4
...
plot <- ggplot(cpm_comparison, aes(x = CPM_RNA002, y = CPM_RNA004)) +
  ...
  scale_x_log10() +
  scale_y_log10() +
  labs(title = "Counts per million reads, high accuracy basecalling (T. thermophila)",
       x = "RNA002",
       y = "RNA004") +
  theme_minimal() +
  coord_fixed(ratio = 1)
