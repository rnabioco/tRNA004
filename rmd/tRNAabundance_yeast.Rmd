...
library(forcats)
library(here)
here::i_am("Rmd/tRNAabundance_yeast.Rmd")
```
...
read_tRNA(here("rebasecalling/bedgraphs/WTyeast002_20231111_1103_P2S-00519-A_PAS43478_1fa49e43.rna002_70bps_fast@v3.bg"), "S_cerevisiae", "RNA002", "fast") -> fast2
read_tRNA(here("rebasecalling/bedgraphs/WTyeast002_20231111_1103_P2S-00519-A_PAS43478_1fa49e43.rna002_70bps_hac@v3.bg"), "S_cerevisiae", "RNA002", "hac") -> hac2
read_tRNA(here("rebasecalling/bedgraphs/WTyeast004_20231111_1104_P2S-00519-B_PAQ47538_fa3726ec.rna004_130bps_fast@v3.0.1.bg"), "S_cerevisiae", "RNA004", "fast") -> fast4
read_tRNA(here("rebasecalling/bedgraphs/WTyeast004_20231111_1104_P2S-00519-B_PAQ47538_fa3726ec.rna004_130bps_hac@v3.0.1.bg"), "S_cerevisiae", "RNA004", "hac") -> hac4
read_tRNA(here("rebasecalling/bedgraphs/WTyeast004_20231111_1104_P2S-00519-B_PAQ47538_fa3726ec.rna004_130bps_sup@v3.0.1.bg"), "S_cerevisiae", "RNA004", "sup") -> sup4
...
plot <- ggplot(cpm_comparison, aes(x = CPM_RNA002, y = CPM_RNA004)) +
  ...
  scale_x_log10() +
  scale_y_log10() +
  labs(title = "Counts per million reads, high accuracy basecalling (S. cerevisiae)",
       x = "RNA002",
       y = "RNA004") +
  theme_minimal() +
  coord_fixed(ratio = 1)
